...
const page = () => {
  ...
  return (
    <div className="flex justify-center items-center">
      ...
      <form className="flex flex-col gap-2 shadow-lg bg-slate-400 dark:bg-slate-700 p-16 rounded-md mt-20" onSubmit={handleSubmit}>
      <h2 className="text-2xl font-bold mb-4 text-center">Forgot Password</h2>
        <div className="flex flex-col">
            <label>Email Address</label>
          <input className="p-2 rounded dark:bg-slate-600 " type="email" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)} />
        </div>
